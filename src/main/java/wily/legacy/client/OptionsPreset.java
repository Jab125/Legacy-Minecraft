...
public record OptionsPreset(Identifier id, Optional<Component> name, Optional<Component> tooltip, Map<String, Object> legacyOptions, Map<String, Object> vanillaOptions) implements IdValueInfo<OptionsPreset> {
