...
public record GlobalPacks(List<String> list, boolean applyOnTop) {
    ...
    public static final FactoryConfig<GlobalPacks> globalResources = STORAGE.register(FactoryConfig.create("globalResources", null, () -> CODEC, EMPTY.withPacks(List.of("legacy:legacy_resources")), v -> {
    }, STORAGE));
    ...
    public static class Selector extends AbstractWidget implements ControlTooltip.ActionHolder {
        ...
        public void updateModel() {
            model = new PackSelectionModel(e -> {
            }, PackAlbum.Selector::getPackIcon, packRepository, r -> {
            });
        }
