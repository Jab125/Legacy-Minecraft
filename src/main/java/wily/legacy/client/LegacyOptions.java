...
public class LegacyOptions {
    ...
    private static boolean loadingClientOptions;
    ...
    private static void reloadCloudRendering() {
        ...
        minecraft.execute(() -> {
            ...
            if (minecraft.levelRenderer != null) {
                //~ if >=26.2 '.getCloudRenderer()' -> '.cloudRenderer()'
    ...
    public static float getLeftStickDeadZone() {
        Minecraft minecraft = Minecraft.getInstance();
        return FactoryAPIClient.getScreen() == null && minecraft.player != null && minecraft.player.getControlledVehicle() instanceof AbstractBoat ? 0.5f + leftStickDeadZone.get().floatValue() / 2 : leftStickDeadZone.get().floatValue();
    }
