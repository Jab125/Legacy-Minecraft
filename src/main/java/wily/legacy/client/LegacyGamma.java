...
public class LegacyGamma implements AutoCloseable {
    ...
    public void render() {
        ...
        *///?} else {
        ...
        try (RenderPass renderPass = commandEncoder.createRenderPass(() -> "Display Legacy Gamma", target.getColorTextureView(), Optional.empty(), target/*? if <26.3 {*//*.useDepth*//*?} else {*/.hasDepth()/*?}*/ ? target.getDepthTextureView() : null, OptionalDouble.empty())) {
