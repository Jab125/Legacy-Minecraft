...
public class ControllerMappingScreen extends LegacyKeyMappingScreen {
    ...
    public void addButtons() {
        ...
        renderableVList.addRenderable(Button.builder(Component.translatable("legacy.menu.reset_defaults"), button -> FactoryAPIClient.setScreen(new ConfirmationScreen(this, Component.translatable("legacy.menu.reset_controls"), Component.translatable("legacy.menu.reset_controls_message"), b -> {
