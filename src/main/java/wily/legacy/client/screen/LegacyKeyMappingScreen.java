...
public class LegacyKeyMappingScreen extends OptionsScreen {
    ...
    public void addButtons() {
        ...
        renderableVList.addRenderable(Button.builder(Component.translatable("legacy.menu.reset_defaults"), button -> FactoryAPIClient.setScreen(new ConfirmationScreen(this, Component.translatable("legacy.menu.reset_keyBinds"), Component.translatable("legacy.menu.reset_keyBinds_message"), b -> {
