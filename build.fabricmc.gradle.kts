...
val semver = if (stonecutter.current.version == "26.3") "26.3-alpha.1" else stonecutter.current.version
val realver = if (stonecutter.current.version == "26.3") "26.3-snapshot-1" else stonecutter.current.version
